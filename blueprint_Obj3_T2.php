          ...
          <table summary="This table shows how to create responsive tables using Bootstrap's default functionality" class="table table-bordered table-hover jumbotron">
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>2</td>
                <td>Play the visualization for the multiple conditions to show relationship between 2 representations:<br>
                  <span style="color: #EC911E;"><b><?php echo $_SESSION['P9binput1_text']; ?></b></span>
                 </td>
                  <td>Listens & Observes  

                  </td>
                  <td><ul><li> Play button </li><li>Simultaneous</li>
                    representation <li><span style="color: #EC911E;"><b><?php p9binput7_radioNested_elementF(); ?></b></span></li></ol>
                    <br>
                ...
                <tr>
                 ...
                 <td>Pose the activity question :<br>
                  <span style="color: #EC911E;"><b><?php echo $_SESSION['P11input1_text']; ?></b></span>(<br>
                </td>
              ...
              <tr>
               ...
               <td>Show Think phase question: Individual activity<br>
                <span style="color: #EC911E;"><b><?php echo $_SESSION['P19input11_text']; ?></b></span><br>
              </td>
              <td>Individual Activity ‘Thinks’ about the answer for 2 – 3 mins.
              </td>
              <td> <ul><li> </li></ul>
              </td>
            ...
            <tr>
              ...
              <td>Writes down the answer with reasoning<br>
                <div class="bs-callout bs-callout-success">
                  <h4>Pedagogical pointer:</h4>
                  Strategy Implementation steps</div></td>
                </td>
                <td></td>
              </tr>
              <tr>
                  ...
                  <ul>
                    ...
                    <li>
                      <ul>
                        ...
                        <li><span style="color: #EC911E;"><b><?php echo $_SESSION['P19input5_text']; ?></b></span></li>
              ...
              <tr>
                ...
                <td><ul><li>Ask random student groups to share their solutions with the class. Highlight important points of each answer.</li></ul>
                </td> 
                <td><b>Group Activity</b><br><ul><li>Presents their group solution to the class.</li></ul></td> 
                <td></td>
              </tr>
              ...
              <tr>
                ...
                <td><ul>
                  ...
                  <ol>
                    <li><span style="color: #EC911E;"><b><?php echo $_SESSION['P19input6_text']; ?></li>
              ...
              <td><b>Group Activity</b><br><ul><li>Compares their solution with what is shown on-screen</li></ul> 
            ...
            <tr>
              ...
              <td><ol type="a"><li> Run the visualization with the given input value.</li></td> 
              <td><ul><li>Notes the difference, if any, with their solution </li><li> Receives instructor feedback on their errors</li></ul></td> 
              <td><span style="color: #EC911E;"><b><?php p19input7_radioNested_elementF (); ?></b></span><br>
               <div class="bs-callout bs-callout-success">
                <h4>Pedagogical pointer:</h4>
                Pedagogical utility of this visualization feature
              </div>
