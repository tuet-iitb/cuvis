    ...
    <div  id="printableDiv">
      ...
      <div class="container col-lg-10 ">
        ...
        <div class="table-responsive  col-lg-12">
          <table summary="This table shows how to create responsive tables using Bootstrap's default functionality" class="table table-bordered table-hover jumbotron">
            ...
            <tr>
             ...
             <td>Pose the activity question :<br>
              <span style="color: #EC911E;"><b><?php echo $_SESSION['P20input1_text']; ?></b></span>(<br>
            </td>
          ...
          <tr>
           ...
           <td>Show Think phase question: Individual activity<br>
            <span style="color: #EC911E;"><b><?php echo $_SESSION['P20input11_text']; ?></b></span><br>
          </td>
        ...
        <tr>
              ...
              <ul>
                ...
                <li>
                  <ul>
                    ...
                    <li><span style="color: #EC911E;"><b><?php echo $_SESSION['P20input5_text']; ?></b></span></li>
          ...
          <tr>
            ...
            <td><ul>
              ...
              <ol>
                <li><span style="color: #EC911E;"><b><?php echo $_SESSION['P20input6_text']; ?></li>
        ...
        <tr>
          ...
          <td> <span style="color: #EC911E;"><b><?php p20input7_radioNested_elementF (); ?></b></span><br>
           <div class="bs-callout bs-callout-success">
            <h4>Pedagogical pointer:</h4>
            Pedagogical utility of this visualization feature
          </div>
