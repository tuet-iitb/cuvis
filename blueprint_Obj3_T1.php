            ...
            <table summary="This table shows how to create responsive tables using Bootstrap's default functionality" class="table table-bordered table-hover jumbotron">
              ...
              <tbody>
                <tr>
                  <td>1</td>
                  <td>2</td>
                  <td>Play the visualization for the multiple conditions selected to show relationship between 2 representations:<br>
                  ...
                  <td>
                    <ul>
                      <li> Play button </li><li>Simultaneous representation</li>
                      <li><span style="color: #EC911E;"><b><?php p9binput7_radioNested_elementF(); ?></b></span></li>
                    </ul>
                ...
                <tr>
                 ...
                 <td>Show the activity question :<br>
                  <span style="color: #EC911E;"><b><?php echo $_SESSION['P17input11_text']; ?></b></span><br>
                  <span style="color: #EC911E;"><b><?php echo $_SESSION['P17input5_text']; ?></b></span>
                </td>
              ...
              <tr>
                ...
                <td>Raises hand when instructor calls out their answer</td>
              ...
              <tr>
                ...
                <td><b>Group Activity</b><br>
                  <ul>
                    ...
                    <li>Each group arrives at a common answer </li></ul>  
                    <div class="bs-callout bs-callout-success">
                      <h4>Pedagogical pointer:</h4>
                ...
                <tr>
                  ...
                  <td><b>Individual Activity</b><br>
                    <ul>
                      <li>Votes again by show of hands</li>
                    </ul> 
                  </td> 
                  <td></td>
                </tr>
                <tr>
                  ...
                  <td> 
                    <span style="color: #EC911E;"><b><?php p17input7_radioNested_elementF (); ?></b></span><br>
                    <div class="bs-callout bs-callout-success">
                      <h4>Pedagogical pointer:</h4>
                      Pedagogical utility of this visualization feature
                    </div>
                ...
                <tr>
                  ...
                  <td><ul>
                    <li> Show the activity question :</li>
                    <span style="color: #EC911E;"><b><?php echo $_SESSION['P18input1_text']; ?></b></span>
                    <li>Repeat steps 4 – 7 outlined above.</li>
                  </ul>
                </td>  
                <td>Individual Activity ‘Thinks’ about the answer for 2 – 3 mins.</td> 
                <td> 
                  <ul>
                    <li>Pause button</li>
                    <li><span style="color: #EC911E;"><b><?php p18input7_radioNested_elementF (); ?></b></span></li>
                  </ul>
