                ...
                <tbody>
                  <tr>
                    ...
                    <td>Play the visualization & Pause at this point.<br>Enter the multiple condition sets to show relationship between various system variables
                      <span style="color: #EC911E;"><b><?php p5input7_radioNested_elementF(); ?></b></span>                  
                    </td>
                    ...
                    <td>
                      <ul>
                        ...
                        <ul>
                          ...
                          <li>
                            <span style="color: #EC911E;"><b><?php echo $_SESSION['P10input5_text']; ?></b></span>
                          </li>
                  ...
                  <tr>
                    ...
                    <td>  
                      <span style="color: #EC911E;"><b><?php p10input7_radioNested_elementF (); ?></b></span><br>
                      <div class="bs-callout bs-callout-success">
                        <h4>Pedagogical pointer:</h4>
