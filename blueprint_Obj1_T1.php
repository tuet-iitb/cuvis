            ...
            <table summary="This table shows how to create responsive tables using Bootstrap's default functionality" class="table table-bordered table-hover jumbotron">
              ...
              <tbody>
                <tr>
                  <td>1</td>
                  <td>2</td>
                  <td>Play the visualization for the multiple conditions selected:<br>
                ...
                <tr>
                  ...
                  <td>Pause the visualization at this point.<br>
                    <span style="color: #EC911E;"><b><?php echo $_SESSION['P29input4_image']; ?></b></span><br>
                    <div class="bs-callout bs-callout-success">
                      <h4>Pedagogical pointer:</h4>
                      Pausing to do an activity with visualization
                    </div>
                ...
                <tr>
                 ...
                 <td>Show the activity question :<br>
                  <span style="color: #EC911E;"><b><?php echo $_SESSION['P12input1_text']; ?></b></span><br>
                  <span style="color: #EC911E;"><b><?php echo $_SESSION['P12input11_text']; ?></b></span>
                  <div class="bs-callout bs-callout-success">
                    <h4>Pedagogical pointer:</h4>
              ...
              <tr>
                ...
                <td>Raises hand when instructor calls out their answer<br>
                  <div class="bs-callout bs-callout-success">
                    <h4>Pedagogical pointer:</h4>
              ...
              <tr>
                ...
                <td> Enter the visualization features>
                  <span style="color: #EC911E;"><b><?php p12input7_radioNested_elementF (); ?></b></span><br>
                  <div class="bs-callout bs-callout-success">
                    <h4>Pedagogical pointer:</h4>
