      ...
      <div class="container col-lg-10 ">
        ...
        <div class="table-responsive  col-lg-12">
          ...
          <tr>
            ...
            <td><ol type="a">Ask students to : <br>
              <li> Compare your answer with the solution being shown</li>
              <li>Underline the errors you find in your solution</li>
            ...
            <td><b>Group Activity</b><br><ol type="a"><li>Compares their solution with what is shown on-screen</li><li>Modifies their solution, if required</li></ol>
              <div class="bs-callout bs-callout-success">
                <h4>Pedagogical pointer:</h4>
          ...
          <tr>
            ...
            <td> Enter the visualization features <span style="color: #EC911E;"><b><?php p16input7_radioNested_elementF (); ?></b></span><br>
             <div class="bs-callout bs-callout-success">
              <h4>Pedagogical pointer:</h4>
              Pedagogical utility of this visualization feature
            </div>
