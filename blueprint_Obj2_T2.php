            ...
            <table summary="This table shows how to create responsive tables using Bootstrap's default functionality" class="table table-bordered table-hover jumbotron">
              ...
              <tbody>
                <tr>
                  <td>1</td>
                  <td rowspan="4">3-5</td>
                  <td>Play the visualization & Pause at this point.<br>Enter the multiple condition sets to show relationship between various system variables
                ...
                <tr>
                  ...
                  <td>Pose the activity question :<br>
                    <span style="color: #EC911E;"><b><?php echo $_SESSION['P10input1_text']; ?></span>
                      
                    </td>
                    <td>Reads the activity question 
                ...
                <tr>
                 ...
                 <td>Show Think phase question: Individual activity <br>
                  <span style="color: #EC911E;"><b><?php echo $_SESSION['P10input11_text']; ?></b></span><br>
                  <div class="bs-callout bs-callout-success">
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <ul>
                      <li>Ask students to think individually & write down their answer with reasoning</li>
                    </ul>
                  </td>
                  ...
                  <td>
                    <ul>
                      ...
                      <ul>
                        ...
                        <li><span style="color: #EC911E;"><b><?php echo $_SESSION['P10input5_text']; ?></b></span></li>
                ...
                <tr>
                  ...
                  <td>
                    <ol>
                      ...
                      <ol>
                        <li><span style="color: #EC911E;"><b><?php echo $_SESSION['P10input6_text']; ?></b></span></li>
                ...
                <tr>
                  ...
                  <td><ul>Run the visualization with the given input value</ul></td> 
                  <td>
                    <ul>
                  ...
                  <td>  <span style="color: #EC911E;"><b><?php p10input7_radioNested_elementF (); ?></b></span><br>
                   <div class="bs-callout bs-callout-success">
                    <h4>Pedagogical pointer:</h4>
              ...
              <tr id="col9">
                ...
                <td>Students relate the topic to real-life<br></td> 
                <td></td> 
              </tr>
