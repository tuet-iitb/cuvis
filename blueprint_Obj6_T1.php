              ...
              <tr>
                ...
                <tr>
                 ...
                 <td>Show the activity question :<br>
                  nsert PI question with options><span style="color: #EC911E;"><b><?php echo $_SESSION['P21input11_text']; ?></b><br>
                    <span style="color: #EC911E;"><b><?php echo $_SESSION['P21input5_text']; ?></b></span><br>
                </td>
              ...
              <tr>
                ...
                <tr>
                  ...
                  <td><ul><li>Notes the difference, if any, with their solution </li><li> Receives instructor feedback on their errors</li></ul>
                    ...
                    <td> Enter the visualization features><span style="color: #EC911E;"><b><?php p21input7_radioNested_elementF (); ?></b></span><br>
                  ...
                  <tr>
                    ...
                    <td><ul><li>Pause button</li>
                      <li>Enter the visualization features><span style="color: #EC911E;"><b><?php p22input7_radioNested_elementF (); ?></b></span></li> </ul><br>
